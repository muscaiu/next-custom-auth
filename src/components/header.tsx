      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div>
            <Link
              href="/"
              className="bg-gradient-to-r from-pink-500 to-yellow-500 bg-clip-text text-transparent text-2xl font-bold"
            >
              All Star.
            </Link>
          </div>
          <ul className="flex items-center gap-4">
            <li>
              <Link
                href="/"
                className="text-white hover:text-pink-500 font-semibold"
              >
                Home
              </Link>
            </li>
